...
class Publicacones extends React.Component {
	async componentDidMount() {
		...
		if (!('publicaciones_key' in this.props.usuariosReducer.usuarios[key])) publicacionesTraerPorUsuario(key);
	}
...
export default connect(mapStateToProps, mapDispatchToProps)(Publicacones);
